...
/*
   ...
   memory.cpp contains the implementations for memory.hpp — creating GPU
   buffers via VMA, copying data into them, extracting device addresses, and
   the image barriers that keep layouts in sync with the driver.
